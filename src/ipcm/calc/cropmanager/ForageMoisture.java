...
public class ForageMoisture extends CalculatorActivity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        input1 = (EditText)findViewById(R.id.input1); // Negotiated price
        input2 = (EditText)findViewById(R.id.input2); // In-field moisture
        input3 = (EditText)findViewById(R.id.input3); // Negotiated moisture
        result = (TextView)findViewById(R.id.result);
        emailButton = (Button)findViewById(R.id.email);
        mainLayout = (RelativeLayout)findViewById(R.id.forage_main);
    ...
    public void help(View v){
        Intent i = new Intent(this, ForageHelp.class);
        startActivity(i);
    }
